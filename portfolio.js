...
// Ampliando os sites do portfólio
...
const loadPopUp = (evento) => {
    ...
    document.getElementById('info-icon').dataset.info = `${sites[whichSite].info}`
    if(whichSite){
        document.getElementById('site').innerHTML = `${sites[whichSite].code}`
        openPopUp()
